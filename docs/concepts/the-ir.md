...
- primitive names identify operations such as {py:func}`format <autoform.string.format>`, {py:func}`concat <autoform.string.concat>`, and {py:func}`lm_call <autoform.lm_call>`;
