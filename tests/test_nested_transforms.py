...
class TestPushforwardOfBatch:
    def test_pushforward_of_batch_ir(self):
        ...
        p_xs = ["a", "b"]
        t_xs = ["da", "db"]
        result = pf_batch_ir.call((p_xs, t_xs))
        assert result == (
            ["Value: a!", "Value: b!"],
            ["Value: da!", "Value: db!"],
        )
...
class TestPullbackOfBatch:
    def test_pullback_of_batch_ir(self):
        ...
        p_xs = ["a", "b"]
        cotangent_out = ["g1", "g2"]
        result = pb_batch_ir.call((p_xs, cotangent_out))
        assert result == (
            ["Value: a!", "Value: b!"],
            ["g1", "g2"],
        )
...
class TestTripleNesting:
    ...
    def test_pushforward_of_pushforward_of_batch(self):
        ...
        result = pf2.call(((p_xs, t1_xs), t2_xs))
        assert result == (
            (["a!", "b!"], ["t1a!", "t1b!"]),
            (["t2a!", "t2b!"], ["t2t1a!", "t2t1b!"]),
        )
...
class TestMixedDeepNesting:
    ...
    def test_pullback_pushforward_batch(self):
        ...
        result = pb.call(((p_inputs, t_inputs), cotangent_out))
